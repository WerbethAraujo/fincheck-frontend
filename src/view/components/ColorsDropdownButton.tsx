...
interface ColorsDropdownButtonProps {
  className?: string;
  error?: string;
}
...
export function ColorsDropdownButton({
  className,
  error,
}: ColorsDropdownButtonProps) {
    ...
    <div>
      <DropdownMenu.Root>
        <DropdownMenu.Trigger>
          <button
            className={cn(
              "relative text-gray-700 bg-white w-full rounded-lg border border-gray-500 px-3 h-[52px] focus:border-gray-800 transition-all outline-none text-left",
