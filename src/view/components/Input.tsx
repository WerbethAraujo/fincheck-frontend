  ...
  ({ placeholder, name, id, error, className, ...props }, ref) => {
    ...
    return (
      <div className="relative">
        ...
        <label
          htmlFor={inputId}
          className="absolute text-xs text-gray-700 left-[13px] top-2 pointer-events-none peer-placeholder-shown:text-base peer-placeholder-shown:top-3.5 transition-all"
        >
          {placeholder}
        </label>
        {error && (
